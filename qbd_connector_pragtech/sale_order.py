...
def import_QBD_Sales_Order_to_TPA():
    try:
        ...
        if to_execute_account == 1:
            ...
            # print (time_modified)
            sale_order = "SELECT TOP {} TxnID, CustomerRefListID, IsFullyInvoiced, TxnDate, RefNumber, Memo, Timemodified FROM SalesOrder where timemodified >={} and IsFullyInvoiced = False order by Timemodified ASC".format(limit, time_modified)
