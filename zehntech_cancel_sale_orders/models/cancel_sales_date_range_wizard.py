...
class CancelSalesDateRangeWizard(models.TransientModel):

    _name = 'cancel.sales.date.range.wizard'

    _description = 'Cancel Sales Custom Date Range Wizard'

    dashboard_id = fields.Many2one('cancel.sales.dashboard', string="Dashboard", required=True)
